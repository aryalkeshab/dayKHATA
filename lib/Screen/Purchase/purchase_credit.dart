...
import 'package:my_app/Screen/Purchase/purchase_credit2.dart';
...
class PurchaseCredit extends StatelessWidget {
  const PurchaseCredit({Key? key}) : super(key: key);
